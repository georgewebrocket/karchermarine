...
{	
	static function breadcrumbs($type, $post) {
		...
		if ($type=="wp") {
			...
			foreach ($breadcrumbs as $key => $value) {
				$breadcrumbs_str .= '<li><a href="category.php?id='.$breadcrumbs[$key]['id'].'">'.$breadcrumbs[$key]['name'].'</a>></li>';
			}
	...
	static function richcontent($str, $params = NULL) {
		...
		$str = str_replace("[COL-6]", "<div class=\"col-6 col-sm-12\"><div style=\"margin-right:10px\">", $str);
		$str = str_replace("[COL-4]", "<div class=\"col-4 col-sm-12\"><div style=\"margin-right:10px\">", $str);
		$str = str_replace("[COL-3]", "<div class=\"col-3 col-sm-12\"><div style=\"margin-right:10px\">", $str);
		$str = str_replace("[COL-2]", "<div class=\"col-2 col-sm-6\"><div style=\"margin-right:10px\">", $str);
		$str = str_replace("[COL-1]", "<div class=\"col-1 col-sm-4\"><div style=\"margin-right:10px\">", $str);
		$str = str_replace(array("[/COL-6]", "[/COL-4]", "[/COL-3]", "[/COL-2]", "[/COL-1]"), "</div></div>", $str);
	...
	static function tabs($str) {
		...
		$ar = explode("====", $str);
                if($ar[0] != ""){
                    ...
                    $result = "<ul id=\"tab-menu\" class=\"tab-menu\">".$tabsmenu . "<div style=\"clear:both\"></div></ul>" . 
	...
	static function getproducts($str, $cat) {
		//$str = file_get_contents("http://demo.karcher-marine.com/_products.php?id=".$cat);
                $str = file_get_contents(app::$host."_products.php?id=".$cat);
		return $str;
		//return "http://demo.karcher-marine.com/_products.php?id=".$cat;
	}
