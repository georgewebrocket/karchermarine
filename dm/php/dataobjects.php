...
protected $_myconn, $_id, $_parent_id, $_title, $_short_description, $_description, $_photo, $_product_image, $_level, $_nodes ;
...
protected $_myconn, $_id, $_category_id, $_item_code, $_title, $_short_description, $_description, $_features_benefits, $_photo, $_extra_images, $_downloads, $_related_product_ids, $_accessories_ids, $_cleaning_agents_ids, $_compatible_machines_ids, $_standard_accessories_ids, $_active, $_clicks_counter ;
