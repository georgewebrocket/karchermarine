...
require_once '../../../phpmailer/test/PHPUnit/Autoload.php';
...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (file_exists('../../../phpmailer/test/testbootstrap.php')) {
            include '../../../phpmailer/test/testbootstrap.php'; //Overrides go in here
        }
