...
if($cat_id > 0){$query = "WHERE attr_category_id = ".$cat_id;}

$sql = "SELECT * FROM app_attributes ".$query;

if($cat_id > 0){$link = "attributes.php?cat_id=".$cat_id."&page=";}else{$link = "attributes.php?id=10&page=";}
$nrOfRows = 20;
