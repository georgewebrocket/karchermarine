...
<div style="margin-left: -30px;">
    <div class="col-12">
        <div class="col-4">
            <div class="menu-item">
                <div class="menu-level-1">
                    <img src="https://karcher-marine.com/demo/img/home_amp_garden_service.jpg" />
                    <h3>Home & Garden</h3>
                    <ul>
        ...
        <div class="col-4">
            <div class="menu-item">
                <div class="menu-level-1">
                    <img src="https://karcher-marine.com/demo/img/professional_service.jpg" />
                    <h3>Professional</h3>
                    <ul>
        ...
        <div class="col-4">
            <div class="menu-item">
                <div class="menu-level-1">
                    <img src="https://karcher-marine.com/demo/img/service_support.jpg" />
                    <h3>Home & Garden </h3>
                    <ul>
